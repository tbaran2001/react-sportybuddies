...
export default function ProfileCard({user, userSports}) {
    ...
    return (
        <StyledPaper>
            <Card sx={{backgroundColor: 'primary.main'}}>
                ...
                <ProfileCardContent userSports={userSports}/>
                <ProfileCardActions expanded={expanded} onExpandClick={handleExpandClick}/>
                <ProfileCardCollapse expanded={expanded} description={user.description}/>
            </Card>
        </StyledPaper>
    );
}